...
function ChiangMaiFoodGuide({ guide }) {
  ...
  return (
    <section className="food-place phuket-food-guide" id="food-chiang-mai">
      <header className="food-place-header phuket-food-header">
        <p className="experiences-kicker">Chiang Mai food guide</p>
        <h3>{guide.heading}</h3>
        <p>{guide.intro}</p>
      </header>

      <div className="phuket-food-filters" role="group" aria-label="Filter Chiang Mai food places">
...
export default ChiangMaiFoodGuide

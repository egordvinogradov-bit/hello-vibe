...
function KohPhanganFoodGuide({ guide }) {
  ...
  return (
    <section className="food-place phuket-food-guide" id="food-koh-phangan">
      <header className="food-place-header phuket-food-header">
        <p className="experiences-kicker">Koh Phangan food guide</p>
        <h3>{guide.heading}</h3>
        <p>{guide.intro}</p>
      </header>

      <div className="phuket-food-filters" role="group" aria-label="Filter Koh Phangan food places">
...
export default KohPhanganFoodGuide
